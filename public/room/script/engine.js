;(function () {
  var Engine = (window.Engine = {
    ...
    init: function (options) {
      ...
      $('<span>').addClass('menuBtn').text(_('restart.')).click(Engine.confirmDelete).appendTo(menu)
          ...
          case 65:
            if (Engine.tabNavigation) {
              if (Engine.activeModule == Ship && Fabricator.tab) {
                ...
                (Engine.activeModule == Ship || Engine.activeModule == Fabricator) &&
                Path.tab
              ) {
          ...
          case 68:
            if (Engine.tabNavigation) {
              if (Engine.activeModule == Room && Outside.tab) {
                ...
                (Engine.activeModule == Path || Engine.activeModule == Fabricator) &&
                Ship.tab
              ) {
